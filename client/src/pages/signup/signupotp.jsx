...
import { verifysignupotp, signupotp } from "../../service/authservice";
...
function Signupotp() {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      setLoading(true);
      const result = await signupotp({ email });
      setInfoMessage(result.message || "A new signup OTP has been sent to your email.");
    } catch (err) {
  ...
  return (
    <div>
      ...
      >
        <h2 className="text-2xl font-bold text-center text-blue-800 mb-6">Verify Signup OTP</h2>
